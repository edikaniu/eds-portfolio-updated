...
import { TrendingUp, Mail, Bot, Search, Users, DollarSign, BarChart3, Zap, Globe, Smartphone, ShoppingCart, Heart, Megaphone, PieChart } from "lucide-react"
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    description:
      "Implemented comprehensive AI automation across marketing operations, resulting in significant productivity gains and workflow optimization.",
    fullDescription:
      "This groundbreaking AI transformation project revolutionized how marketing teams approach their daily operations across multiple client organizations. By implementing a comprehensive suite of AI tools and automation platforms, we fundamentally changed how marketing professionals create content, analyze data, and execute campaigns. The initiative involved identifying repetitive tasks that consumed valuable time, implementing intelligent automation solutions, and training teams to leverage AI effectively while maintaining quality and brand consistency.",
    ...
    tools: ["ChatGPT", "Claude", "Zapier", "HubSpot", "Automation Platforms", "Analytics"],
    category: "AI & Automation",
    color: "from-accent to-purple-600",
    icon: <Bot className="h-6 w-6" />,
    challenge:
      "Marketing teams across multiple organizations were spending 70% of their time on repetitive, manual tasks like data entry, report generation, and basic content formatting. This left minimal time for strategic thinking, creative work, and high-impact initiatives that drive real business growth.",
    solution:
  ...
  {
    id: "user-growth-campaign",
    title: "10,000+ User Growth Campaign",
    subtitle: "Explosive User Acquisition Strategy",
    description:
      "Executed a comprehensive growth campaign that scaled user base from 100 to over 10,000 users through strategic PPC, email automation, and social media marketing.",
    fullDescription:
      "This explosive user growth campaign was designed to rapidly scale a fintech startup's user base through a sophisticated multi-channel approach. The strategy combined data-driven PPC campaigns, advanced email automation sequences, and targeted social media marketing to create a powerful user acquisition engine. The campaign focused on identifying high-value user segments, optimizing conversion funnels at every stage, and implementing retention strategies to ensure sustainable, long-term growth rather than just short-term spikes.",
    ...
    tools: ["Google Ads", "Meta Ads", "Mailchimp", "Analytics", "A/B Testing", "Automation"],
    category: "Growth Marketing",
    color: "from-primary to-blue-600",
    icon: <TrendingUp className="h-6 w-6" />,
    challenge:
      "The fintech startup had a solid product with strong product-market fit but struggled with user acquisition, having only 100 active users despite being in the market for 6 months. They needed rapid, sustainable growth while maintaining quality users and optimizing acquisition costs.",
    solution:
      "Developed an integrated growth strategy combining paid advertising across multiple channels, content marketing, email automation, and social proof to create multiple touchpoints and conversion opportunities throughout the entire customer journey.",
    timeline: [
      {
  ...
  },
  {
    ...
    tools: ["Mailchimp", "ConvertKit", "Leadpages", "Zapier", "Canva", "Analytics"],
    category: "Email Marketing",
    color: "from-green-500 to-emerald-600",
    icon: <Mail className="h-6 w-6" />,
    challenge:
      "The existing email list of 3,000 subscribers had very low engagement rates with minimal revenue contribution. Most subscribers were inactive, open rates were below 18%, and the company was struggling to grow their list organically while maintaining quality subscribers.",
    solution:
      "Implemented a comprehensive email marketing strategy with targeted lead magnets, segmented campaigns, automated sequences, and optimized opt-in forms designed to attract, engage, and convert subscribers while maintaining high deliverability and engagement rates.",
    timeline: [
      {
  ...
  {
    id: "organic-traffic-growth",
    title: "Organic Traffic Surge",
    subtitle: "200% Organic Growth Strategy",
    description:
      "Implemented AI-enhanced content distribution strategy that resulted in a 200% increase in organic traffic within 4 months.",
    fullDescription:
      "This comprehensive organic growth strategy leveraged AI-enhanced content creation and distribution to dramatically increase organic search traffic and engagement. The campaign focused on creating high-quality, SEO-optimized content that resonated with target audiences while utilizing AI tools to scale content production without sacrificing quality. The strategy included keyword research, content optimization, technical SEO improvements, and strategic content distribution across multiple channels.",
    ...
    tools: ["Google Analytics", "SEMrush", "Ahrefs", "ChatGPT", "Content Calendar", "Search Console"],
    category: "SEO & Content",
    color: "from-orange-500 to-red-500",
    icon: <Search className="h-6 w-6" />,
    challenge:
      "The website had minimal organic visibility with low search rankings and limited content strategy. Organic traffic was stagnant, and the company was heavily dependent on paid advertising for lead generation, resulting in high customer acquisition costs.",
    solution:
      "Developed a comprehensive SEO and content strategy that combined AI-enhanced content creation with technical optimization, strategic keyword targeting, and systematic content distribution to build sustainable organic growth.",
    timeline: [
      {
  ...
  },
  {
    ...
    description:
      "A fintech startup needed to scale from 100 to 10,000+ users while maintaining product-market fit and optimizing customer acquisition costs.",
    fullDescription:
      "This comprehensive growth campaign was designed to rapidly scale Suretree Systems' user base through a multi-channel approach. The strategy combined data-driven PPC campaigns, sophisticated email automation sequences, and targeted social media marketing to create a powerful user acquisition engine. The campaign focused on identifying high-value user segments, optimizing conversion funnels, and implementing retention strategies to ensure sustainable growth.",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop",
    metrics: {
      primary: "10,000%",
      primaryLabel: "User Growth",
    ...
    icon: <TrendingUp className="h-6 w-6" />,
    challenge:
      "Suretree Systems had a solid product but struggled with user acquisition, having only 100 active users despite being in the market for 6 months. The challenge was to rapidly scale the user base while maintaining product-market fit and optimizing customer acquisition costs.",
    solution:
      "Developed an integrated growth strategy combining paid advertising, content marketing, email automation, and social proof to create multiple touchpoints and conversion opportunities across the entire customer journey.",
    timeline: [
      {
        phase: "Market Research & Strategy",
        duration: "1 week",
  ...
  },
  {
    ...
    icon: <Mail className="h-6 w-6" />,
    challenge:
      "The existing email list of 3,000 subscribers had low engagement rates and minimal revenue contribution, with most subscribers being inactive or unengaged. The company needed to dramatically increase both list size and engagement.",
    solution:
      "Implemented a comprehensive email marketing strategy with targeted lead magnets, segmented campaigns, and automated sequences designed to attract, engage, and convert subscribers while maintaining high deliverability and engagement rates.",
    timeline: [
      {
        phase: "List Audit & Strategy",
        duration: "1 week",
  ...
  },
  {
    ...
    icon: <Bot className="h-6 w-6" />,
    challenge:
      "Marketing teams were spending 70% of their time on repetitive tasks like data entry, report generation, and basic content formatting, leaving little time for strategic initiatives and creative work that drives real business growth.",
    solution:
      "Implemented a comprehensive AI automation stack that included intelligent content generation, automated reporting, smart workflow optimization, and AI-enhanced processes across all marketing channels and operations.",
    timeline: [
      {
  ...
  },
  {
    ...
    description:
      "An e-commerce platform experienced high traffic but low conversion rates, indicating significant optimization opportunities in the user journey.",
    fullDescription:
      "This comprehensive conversion rate optimization project involved a systematic analysis of the entire e-commerce funnel, from product discovery to checkout completion. Through advanced analytics, user behavior tracking, and extensive A/B testing, we identified key friction points and implemented strategic improvements that dramatically increased conversion rates across all product categories and customer segments.",
    ...
    challenge:
      "Despite attracting significant traffic, the e-commerce platform was converting only 1.2% of visitors to customers, well below the industry average. Cart abandonment rates were extremely high at 78%, and mobile performance was particularly poor.",
    solution:
      "Implemented a data-driven CRO strategy focusing on user experience optimization, mobile responsiveness, trust signals, and checkout flow improvements. Used extensive testing and analytics to validate each optimization.",
    timeline: [
      {
  ...
  },
  {
    ...
    description:
      "A tech brand needed to build awareness and engagement across social platforms to support product launches and community building.",
    fullDescription:
      "This comprehensive social media growth strategy focused on building an authentic, engaged community across multiple platforms. Through strategic content creation, influencer partnerships, community management, and data-driven optimization, we transformed the brand's social presence from minimal to massive, creating a loyal following that actively engages with and promotes the brand.",
    ...
    challenge:
      "The brand had minimal social media presence with only 2,000 followers and extremely low engagement rates. Content was inconsistent, and there was no clear social media strategy or community management approach.",
    solution:
      "Developed a comprehensive social media strategy including content pillars, posting schedules, community guidelines, influencer partnerships, and engagement tactics designed to build authentic relationships and drive meaningful growth.",
    timeline: [
      {
  ...
  },
  {
    ...
    description:
      "A B2B software company needed to increase brand recognition and generate qualified leads in a competitive market segment.",
    fullDescription:
      "This integrated brand awareness campaign leveraged multiple touchpoints to establish market presence and drive lead generation. Through strategic PR, content marketing, thought leadership, event marketing, and digital advertising, we created a cohesive brand narrative that resonated with target audiences and established the company as a trusted industry leader.",
    ...
    challenge:
      "The B2B software company was virtually unknown in their target market despite having a superior product. They needed to build credibility, establish thought leadership, and generate qualified leads in a crowded, competitive space.",
    solution:
      "Created an integrated brand awareness strategy combining thought leadership content, strategic PR, industry event participation, and targeted digital advertising to build credibility and establish market presence.",
    timeline: [
      {
...
export const categories = ["All", "Growth Marketing", "Email Marketing", "AI & Automation", "SEO & Content", "E-commerce", "Social Media", "Brand Marketing"]